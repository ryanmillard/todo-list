...
addTaskForm.onsubmit = function addTaskOnSubmit(event) {
...
window.addEventListener('editTask', (e) => {
  ...
  const task = storage.getTaskByID(currentEditingTaskID);
...
editTaskForm.onsubmit = function editTaskOnSubmit(event) {
  event.preventDefault();
